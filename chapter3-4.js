...
// Intermediate Sums
// You will be given an array of numbers. After every tenth element, add an additional 
// element containing the sum of those ten values. If the array does not end aligned 
// evenly with ten elements, add one last sum that includes those last elements not yet been 
// included in one of the earlier sums. Given the array [1,2,1,2,1,2,1,2,1,2,1,2,1,2], change it 
// to [1,2,1,2,1,2,1,2,1,2,15,1,2,1,2,6].
